...
var (
	...
	// GitLab API metrics
	metricGitLabAPIRequests = promauto.NewCounterVec(prometheus.CounterOpts{
	...
	metricGitLabAPIErrors = promauto.NewCounterVec(prometheus.CounterOpts{
		Name:      "gitlab_api_errors_total",
		Namespace: namespace,
		Subsystem: "pool",
